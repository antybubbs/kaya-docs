  ...
  return (
    <header className="site-header">
      <div className="container header-inner">
        <Link className="brand brand-compact" href="/docs/getting-started/installation" aria-label="Kaya Docs home">
          <img src="/brand/kaya-logo-exact.png" alt="Kaya" />
        </Link>
        <div className="header-tools">
          <SearchBox />
          <nav className="site-nav" aria-label="Main navigation">
            <Link className="nav-link" href="/docs/getting-started/installation">Docs</Link>
