...
Branch installs are documented in [Installation](/docs/getting-started/installation). They build from checked-out Kaya source unless a branch image is published deliberately.
...
- Install, update or release changes: update [Installation](/docs/getting-started/installation), [Updating](/docs/getting-started/updating) and this page.
