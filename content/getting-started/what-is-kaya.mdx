...
Kaya suits homelab owners, system and network administrators, IT support teams, small organisations and technical teams that want to keep their operational records on infrastructure they control. Its three roles support read-only users, operational editors and administrators.
...
The confirmed deployment is a Linux container run with Docker Engine and Docker Compose v2. Users access it through a modern browser. Direct Python execution is useful for development but is not the normal production deployment.
